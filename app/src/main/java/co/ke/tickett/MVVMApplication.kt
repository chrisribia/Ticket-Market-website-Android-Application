...
import co.ke.tickett.ui.CodeConfirm.CodeConfirmViewModelFactory
...
class MVVMApplication : Application(), KodeinAware {
    ...
    override val kodein = Kodein.lazy {
        ...
        bind() from singleton { SellRepository(instance(), instance()) }
        ...
        bind() from provider { CodeConfirmViewModelFactory(instance()) }
